...
file_data = ['evernote:///view/21614375/s192/10b4247b-5f09-4b66-953d-02e5f27aac3c/10b4247b-5f09-4b66-953d-02e5f27aac3c/', 'Anaconda-Navigator://', 'zoom.us://', 'Evernote://', 'Messages://'\
    ,'https://open.spotify.com/track/2gI9RfuSwulsBujm7hbOFv?si=891addaca9524eaf','spotify://', 'workflowy://', 'BRAVE BROWSER', 'https://www.evernote.com/l/AMBXt1MmUlhK6ojyRfy-smKu-InjsFwnoc0'\
]
...
#     ,'sefaria_n', 'havinenu', 'kinneret', 'work_gmail_suite', 'MyZmanim: Jerusalem', 'MyZmanim: Indianapolis', 'GVoice_Telephone'
#     ,'GDRIVE', 'DROPBOX'\
...
row = 0
col = 0
lll = len(link_list) #lll = length of link list
print(lll)
for index in range(lll):
    Button(root, text=f'Button {index + 1}', padx = 50, pady = 50, command=partial(webbrowser.open, link_list[0][index])).grid(row=row, column=col)
    col += 1
    if col >= 5:
        col = 0
        row += 1
